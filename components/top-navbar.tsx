...
// ✅ Import your JSON file with Base64 avatar
...
const mockUser = {
  name: record.name,
  email: record.email,
  avatar: record.avatar, // Base64 avatar from JSON
  isSignedIn: true,
}
        ...
        <div className="flex items-center gap-2 ml-auto">
          ...
          {user.isSignedIn ? (
            <DropdownMenu>
              ...
              <DropdownMenuContent className="w-80 bg-white/95 dark:bg-gray-900/95">
